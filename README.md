...
The aim of the workshop is to get an overview of data analysis and deep learning techniques in the generative artificial intelligence (GAI) domain.
...
* GAI tools for image data using Huggingface models
